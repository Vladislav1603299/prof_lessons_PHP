<?php if(mysqli_num_rows($goods) == 0){ ?>
...
<div style="display:flex; justify-content: space-around; flex-wrap: wrap;">
    ...
    <div style="border: 1px solid black; width: 300px; min-height: 320px; text-align: center">
        ...
        <a href="index.php?c=bascet&act=delGood&id=<?= $data['good_id'] ?>"><input style="margin-bottom: 10px" type="submit" value="Удалить из корзины"></a>
    </div>
    <?php
    }
    ?>
